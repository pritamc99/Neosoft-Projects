...
.product-f-image {
	...
	<div class="maincontent-area" id="bodyContent">
                ...
                <div class="col-md-12">
                    <div class="latest-product">
						...
						<div class="product-carousel">
							<c:forEach items="${letestItem}" var="item">
							<div class="single-product">
                                <div class="product-f-image">
                                    <img src="static/img/<c:out value="${item.imageName}"/>" alt="">
                                ...
                                <h2><a><c:out value="${item.itemName}"/></a></h2>
                                
                                <div class="product-carousel-price">
                                    <ins>Rs.<c:out value="${item.price}"/></ins><!--  <del>$100.00</del> -->
                                </div> 
                            </div>
                            </c:forEach>
						</div>
